...
<body bgcolor="#11AAEE">
	...
	<div style="position:absolute; left:250px; top:85px;">
		<p class="titulo" style="font-size:16px;"> Inicie sesión: </p>
		<div style="position:relative; width:240px; height:150px; background:#DDDDDD; border:2px solid gray; padding:10px;">
