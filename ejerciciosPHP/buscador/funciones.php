<?php
	...
	function crearSelect ($arrayCoches, $atributo, $valor) {
		...
		echo "<select name=\"".$atributo."\" style=\"width:100px;\" onChange=\"buscarCochesAJAX(this.name, this.value)\">";
	...
	//$atributoAJAX = $_REQUEST['atributo'];
	//$valorAJAX = $_REQUEST['valor'];
	...
	function mostrarTablaCoches ($arrayCoches) {
		...
		echo "<tr><th> </th><th>Marca</th><th>Modelo</th><th>Año</th><th>Motor</th><th>Km</th><th>Precio</th></tr>";
